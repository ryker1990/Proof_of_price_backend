...
const transporter = nodemailer.createTransport(
    sendgridTransport({
        auth: {
            api_key:
                "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"
        }
    })
);
...
exports.signup = async (req, res) => {
    try {
        ...
        return res.send({
            data: user,
            msg: "You need to verify your email.Please check your email, We will send you verification code!",
            status: true
        })
    } catch (err) {
       console.log(err);
